...
namespace Xedrial.Physics.Math
{
    public struct PhysicsTransform : IEquatable<PhysicsTransform>
    {
        ...
        public PhysicsTransform(RigidTransform rigidTransform)
        {
            ...
            Rotation = float2x2.Rotate(Xedrial.Physics.Math.PhysicsMath.ZRotationFromQuaternion(rigidTransform.rot));
        }
        ...
        {
            Rotation = float2x2.Rotate(Xedrial.Physics.Math.PhysicsMath.ZRotationFromQuaternion(rotation));
        }
    }
